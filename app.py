...
# --- 🌟 专属定制逻辑：综合净资产 ---
    ...
    with st.expander("📥公司内容分析与注释输入", expanded=False):
        ...
        if check_btn:
            ...
            if pwd_input == "KPMG666":
                try:
                    ...
                    url = "https://raw.githubusercontent.com/minamao0825/annual-report-assets/main/step7-%E5%9B%BE%E7%89%87%E5%86%85%E5%AE%B9%E5%88%86%E6%9E%90%E5%92%8C%E6%B3%A8%E9%87%8A%E6%A8%A1%E6%9D%BF_0608.xlsx"
        ...
        if use_default:
            try:
                df_notes = pd.read_excel("https://raw.githubusercontent.com/minamao0825/annual-report-assets/main/step7-%E5%9B%BE%E7%89%87%E5%86%85%E5%AE%B9%E5%88%86%E6%9E%90%E5%92%8C%E6%B3%A8%E9%87%8A%E6%A8%A1%E6%9D%BF_0608.xlsx")
...
#-----------跨页标题重复---------
    ...
    if print_mode:
        if 'ordered_modules' not in locals() or not ordered_modules:
            ...
            cover_url = "https://raw.githubusercontent.com/minamao0825/annual-report-assets/main/%E6%A0%87%E9%A2%98%E9%A1%B5.png"
            back_url  = "https://raw.githubusercontent.com/minamao0825/annual-report-assets/main/%E5%B0%81%E5%BA%95%E9%A1%B5.png"
            
            appendix_urls = [
                "https://raw.githubusercontent.com/minamao0825/annual-report-assets/main/%E6%96%B0%E5%87%86%E5%88%991.png",
                "https://raw.githubusercontent.com/minamao0825/annual-report-assets/main/%E6%96%B0%E5%87%86%E5%88%992.png",
                "https://raw.githubusercontent.com/minamao0825/annual-report-assets/main/%E6%96%B0%E5%87%86%E5%88%993.png"
            ]
...
# ─────────── Step 3：目标表标准填报 ───────────
        with tab3:
            ...
            template_file = "https://raw.githubusercontent.com/minamao0825/annual-report-assets/main/%E6%96%B0%E5%8D%8E%E6%A0%B7%E4%BE%8B%E8%A1%A8.xlsx" if use_default else st.file_uploader("上传自定义目标表模板 (.xlsx)", type="xlsx", key="unique_template_uploader")
...
格式示例：{"字段名": {"prev": "(1,234.0) + 500.0", "curr": "9,876.54"}}"""
                       ...
                       # 👇 从这里开始补上“完成”的标志符和 UI 提示 👇
                            st.success("🎉 全部处理完毕！带有公式的 Excel 已生成。")
        ...
        with tab4:
            ...
            with col_btn_sample:
                ...
                with st.popover("校验表获取", use_container_width=True):
                    ...
                    import requests
                    url = "https://raw.githubusercontent.com/minamao0825/annual-report-assets/main/%E6%96%B0%E5%8D%8E%E6%A0%B7%E4%BE%8B%E8%A1%A8.xlsx"
